...
class AccountingUnpostedProcurementsApi
{
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAccountingUnpostedprocurementGet(
        $conditions = null,
        $order_by = null,
        ...
        list($response) = $this->financeAccountingUnpostedprocurementGetWithHttpInfo($conditions, $order_by,
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAccountingUnpostedprocurementGetWithHttpInfo(
        $conditions = null,
        $order_by = null,
        $childconditions = null,
        $customfieldconditions = null,
        ...
        try {
            ...
            return [
                $this->apiClient->getSerializer()->deserialize($response,
                    '\Spinen\ConnectWise\Clients\Finance\Model\UnpostedProcurement[]', $httpHeader), $statusCode,
                $httpHeader
            ];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(),
                        '\Spinen\ConnectWise\Clients\Finance\Model\UnpostedProcurement[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(),
