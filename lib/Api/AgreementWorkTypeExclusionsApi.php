...
class AgreementWorkTypeExclusionsApi
{
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAgreementsIdWorkTypeExclusionsGet(
        $id,
        $conditions = null,
        $order_by = null,
        ...
        list($response) = $this->financeAgreementsIdWorkTypeExclusionsGetWithHttpInfo($id, $conditions, $order_by,
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAgreementsIdWorkTypeExclusionsGetWithHttpInfo(
        $id,
        $conditions = null,
        $order_by = null,
        $childconditions = null,
        ...
        try {
            ...
            return [
                $this->apiClient->getSerializer()->deserialize($response,
                    '\Spinen\ConnectWise\Clients\Finance\Model\AgreementWorkTypeExclusion[]', $httpHeader), $statusCode,
                $httpHeader
            ];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
    ...
    {
        list($response) = $this->financeAgreementsIdWorkTypeExclusionsWorkTypeExclusionIdDeleteWithHttpInfo($id,
            $work_type_exclusion_id);
        return $response;
    }
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAgreementsIdWorkTypeExclusionsWorkTypeExclusionIdDeleteWithHttpInfo(
        $id,
        $work_type_exclusion_id
    ) {
        // verify the required parameter 'id' is set
