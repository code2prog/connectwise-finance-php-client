...
class AgreementWorkRoleExclusionsApi
{
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAgreementsIdWorkRoleExclusionsGet(
        $id,
        $conditions = null,
        $order_by = null,
        ...
        list($response) = $this->financeAgreementsIdWorkRoleExclusionsGetWithHttpInfo($id, $conditions, $order_by,
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAgreementsIdWorkRoleExclusionsGetWithHttpInfo(
        $id,
        $conditions = null,
        $order_by = null,
        $childconditions = null,
        ...
        try {
            ...
            return [
                $this->apiClient->getSerializer()->deserialize($response,
                    '\Spinen\ConnectWise\Clients\Finance\Model\AgreementWorkRoleExclusion[]', $httpHeader), $statusCode,
                $httpHeader
            ];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
    ...
    {
        list($response) = $this->financeAgreementsIdWorkRoleExclusionsWorkRoleExclusionIdDeleteWithHttpInfo($id,
            $work_role_exclusion_id);
        return $response;
    }
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAgreementsIdWorkRoleExclusionsWorkRoleExclusionIdDeleteWithHttpInfo(
        $id,
        $work_role_exclusion_id
    ) {
        // verify the required parameter 'id' is set
