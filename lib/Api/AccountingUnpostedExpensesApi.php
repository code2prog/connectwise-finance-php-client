...
class AccountingUnpostedExpensesApi
{
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAccountingUnpostedexpensesGet(
        $conditions = null,
        $order_by = null,
        ...
        list($response) = $this->financeAccountingUnpostedexpensesGetWithHttpInfo($conditions, $order_by,
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAccountingUnpostedexpensesGetWithHttpInfo(
        $conditions = null,
        $order_by = null,
        $childconditions = null,
        $customfieldconditions = null,
        ...
        try {
            ...
            return [
                $this->apiClient->getSerializer()->deserialize($response,
                    '\Spinen\ConnectWise\Clients\Finance\Model\UnpostedExpense[]', $httpHeader), $statusCode,
                $httpHeader
            ];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(),
                        '\Spinen\ConnectWise\Clients\Finance\Model\UnpostedExpense[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(),
    ...
    public function financeAccountingUnpostedexpensesIdGetWithHttpInfo($id)
    {
        ...
        try {
            ...
            return [
                $this->apiClient->getSerializer()->deserialize($response,
                    '\Spinen\ConnectWise\Clients\Finance\Model\UnpostedExpense', $httpHeader), $statusCode, $httpHeader
            ];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
