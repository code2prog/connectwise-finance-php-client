...
class AccountingBatchesApi
{
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAccountingBatchesGet(
        $conditions = null,
        $order_by = null,
        ...
        list($response) = $this->financeAccountingBatchesGetWithHttpInfo($conditions, $order_by, $childconditions,
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAccountingBatchesGetWithHttpInfo(
        $conditions = null,
        $order_by = null,
        $childconditions = null,
        $customfieldconditions = null,
        ...
        try {
            ...
            return [
                $this->apiClient->getSerializer()->deserialize($response,
                    '\Spinen\ConnectWise\Clients\Finance\Model\AccountingBatch[]', $httpHeader), $statusCode,
                $httpHeader
            ];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(),
                        '\Spinen\ConnectWise\Clients\Finance\Model\AccountingBatch[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(),
    ...
    public function financeAccountingBatchesIdExportPostWithHttpInfo($id, $batch_export_parameters)
    {
        ...
        try {
            ...
            return [
                $this->apiClient->getSerializer()->deserialize($response,
                    '\Spinen\ConnectWise\Clients\Finance\Model\GLExport', $httpHeader), $statusCode, $httpHeader
            ];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(),
                        '\Spinen\ConnectWise\Clients\Finance\Model\GLExport', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(),
    ...
    public function financeAccountingBatchesIdGetWithHttpInfo($id)
    {
        ...
        try {
            ...
            return [
                $this->apiClient->getSerializer()->deserialize($response,
                    '\Spinen\ConnectWise\Clients\Finance\Model\AccountingBatch', $httpHeader), $statusCode, $httpHeader
            ];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
