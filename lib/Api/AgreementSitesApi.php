...
class AgreementSitesApi
{
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAgreementsIdSitesGet(
        $id,
        $conditions = null,
        $order_by = null,
        ...
        list($response) = $this->financeAgreementsIdSitesGetWithHttpInfo($id, $conditions, $order_by, $childconditions,
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAgreementsIdSitesGetWithHttpInfo(
        $id,
        $conditions = null,
        $order_by = null,
        $childconditions = null,
        ...
        try {
            ...
            return [
                $this->apiClient->getSerializer()->deserialize($response,
                    '\Spinen\ConnectWise\Clients\Finance\Model\AgreementSite[]', $httpHeader), $statusCode, $httpHeader
            ];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(),
                        '\Spinen\ConnectWise\Clients\Finance\Model\AgreementSite[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(),
