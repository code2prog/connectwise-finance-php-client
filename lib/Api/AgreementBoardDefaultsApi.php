...
class AgreementBoardDefaultsApi
{
    ...
    {
        list($response) = $this->financeAgreementsIdBoardDefaultsBoardDefaultIdDeleteWithHttpInfo($id,
            $board_default_id);
        return $response;
    }
        ...
        try {
            ...
            return [
                $this->apiClient->getSerializer()->deserialize($response,
                    '\Spinen\ConnectWise\Clients\Finance\Model\BoardDefault', $httpHeader), $statusCode, $httpHeader
            ];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(),
                        '\Spinen\ConnectWise\Clients\Finance\Model\BoardDefault', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(),
    ...
    {
        list($response) = $this->financeAgreementsIdBoardDefaultsBoardDefaultIdPatchWithHttpInfo($id, $board_default_id,
            $operations);
        return $response;
    }
    ...
    {
        list($response) = $this->financeAgreementsIdBoardDefaultsBoardDefaultIdPutWithHttpInfo($id, $board_default_id,
            $board_default);
        return $response;
    }
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAgreementsIdBoardDefaultsBoardDefaultIdPutWithHttpInfo(
        $id,
        $board_default_id,
        $board_default
    ) {
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAgreementsIdBoardDefaultsGet(
        $id,
        $conditions = null,
        $order_by = null,
        ...
        list($response) = $this->financeAgreementsIdBoardDefaultsGetWithHttpInfo($id, $conditions, $order_by,
            $childconditions, $customfieldconditions, $page, $page_size);
        return $response;
    }
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     */
    public function financeAgreementsIdBoardDefaultsGetWithHttpInfo(
        $id,
        $conditions = null,
        $order_by = null,
        $childconditions = null,
